...
const solutions = [
  ...
  {
    name: "Fruits",
    description: "Tastiest fruits for your home.",
    href: "#",
    icon: ShieldCheckIcon,
  },
  {
    name: "Trees",
    description: "Prance through the trees, make them jealous.",
    href: "#",
    icon: Squares2X2Icon,
  },
  {
    name: "Vines",
    description: "Climb the vine, not the pine.",
    href: "#",
    icon: ArrowPathIcon,
  },
];
const callsToAction = [
  { name: "Watch Trailer", href: "#", icon: PlayIcon },
